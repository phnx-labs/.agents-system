...
One diagram or chart replaces paragraphs. For rendered/HTML outputs, use
dither-kit by default for charts and quantitative dataviz; use ASCII or inline
SVG for structural diagrams.
